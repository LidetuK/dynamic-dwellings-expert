      ...
      <main className="flex-1 pt-24">
        ...
        <div className="bg-qatken-blue text-white py-12">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Furnished Properties for Rent</h1>
            <p className="text-lg opacity-90 max-w-3xl">
              Explore our premium selection of fully furnished homes ready for immediate move-in.
            </p>
          </div>
        </div>
